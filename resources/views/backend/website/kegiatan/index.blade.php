                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header border-bottom">
                                    <h4 class="card-title">Ekstra Kulikuler  <a href=" {{route('backend-kegiatan.create')}} " class="btn btn-primary">Tambah</a></h4>
                                </div>
                                           ...
                                           @foreach ($kegiatan as $key => $kegiatans)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <form onsubmit="return confirm('Yakin Akan Menghapus Ekskul?')" class="d-inline" action="{{ url('kegiatan/'.$kegiatans->id) }}" method="head">
                                                        {{-- @csrf --}}
                                                        {{-- @method('DELETE') --}}
